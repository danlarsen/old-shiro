        ...
        private void RightText_CharAdded(object sender, CharAddedEventArgs e)
        {
            ...
            try
            {
                ...
                if (symbols == null)
                {
                    ...
                    //functions
                    foreach (string function in ShiroInt.Parser.SymbolTable.fTab.Keys)
                ...
                {
                    string args = "";
                    if (ShiroInt.Parser.SymbolTable.fTab.ContainsKey(backup))
                    {
                        FuncSym fs = ShiroInt.Parser.SymbolTable.fTab[backup];
